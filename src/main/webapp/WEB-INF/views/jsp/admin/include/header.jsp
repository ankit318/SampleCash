...
<!--          <span class="logo-mini"><b>C</b>Name</span>-->
          ...
          <span class="logo-lg"><b> <%=session.getAttribute("userName") %> </b></span>
        </a>
...
<!--              <li class="dropdown tasks-menu">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="<c:url value="resources/admin/dist/img/user2-160x160.jpg"></c:url>" class="user-image" alt="User Image">
